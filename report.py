...
chexnet_weights = 'static/models/brucechou1983_CheXNet_Keras_0.3.0_weights.h5'
tokenizer = joblib.load('static/models/rep/tokenizer.pkl')
model_filename = 'static/models/rep/Encoder_Decoder_global_attention.h5'
